                ...
                if(data[i].user.screen_name != 'NedNuTrality')
                    {
                        ...
                        var hellos = ['Hi',
                                      'Hello',
                                      'Good day'];
                        var greetings = ['Could I talk to you about net neutrality today? It\'s really important to the future of the US.',
                                        'Net Neutrality is one of the most important principles keeping the Internet alive in the US today.',
                                        'I would like to talk about net neutrality and how it\'s vitally important to the US.'];
                        var support = ['Please support these regulations to ensure our Internet is safe and open to all. Please see @fightfortheftr for more info.',
                                      'Please take the time to support these regulations and make sure the internet remains awesome. Please see @fightfortheftr for more info.',
                                      'Please help ensure that next generation has a free and safe internet. Please see @fightfortheftr for more info.'];
                        var displayText = hellos[Math.floor(Math.random()*hellos.length)] + ', ' + greetings[Math.floor(Math.random()*greetings.length)] + ' ' + support[Math.floor(Math.random()*support.length)] ;
                        Twitter.post('statuses/update', {status: '@' + data[i].user.screen_name + ' ' + displayText, in_reply_to_status_id: data[i].id}, function(err, res) {
                            if (err)
                                {
